...
var currentIndex = -1;
//////////////////////////////////////////////////////////////////////////
// show local storage contains
 if(localStorage.getItem('ourTasks')){
   var taskContainer = JSON.parse(localStorage.getItem('ourTasks'));
...
//             <div class="border p-1 w-50 bg-light rounded form-control-lg ${taskClass}">${taskContainer[i].name}</div>
...
// function addUpdate(){
//     taskContainer[currentIndex].name = inputName.value;
//     addInput.classList.add('d-none');
//     btnUpdate.classList.remove('d-none');
//     localStorage.setItem('ourTasks', JSON.stringify(taskContainer));
//     displayTasks();
